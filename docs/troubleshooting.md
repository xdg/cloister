...
4. Domains approved via the web UI are stored in `~/.config/cloister/decisions/` and merged automatically with static config. Check these files if a previously-approved domain stops working.
