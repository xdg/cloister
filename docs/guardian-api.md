...
The guardian exposes three endpoints on different ports:

| Port | Binding | Purpose | Clients |
|------|---------|---------|---------|
| 3128 | `cloister-net` | HTTP CONNECT proxy | Containers |
| 9998 | `cloister-net` | Command execution requests | Containers (hostexec) |
| 9999 | `127.0.0.1` | Approval web UI and API | Host only |
